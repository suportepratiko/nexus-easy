...
export const RULE_TYPE_LABELS: Record<RuleType, string> = {
  candle_body:    "1. Direção da vela atual (Alta ou Baixa)",
  consecutive:    "2. Sequência de velas (Ex: 3 verdes seguidas)",
  wick_size:      "3. Tamanho do Pavio (Rejeição de preço)",
  breakout:       "4. Rompimento (Preço superou máxima anterior)",
  candle_compare: "5. Comparação de preços (Atual vs Anterior)",
  engulfment:     "6. Padrão Engolfo (Reversão)",
  rsi:            "7. Força do Mercado (RSI - Sobrevenda/Sobrecompra)",
  bollinger:      "8. Bandas de Bollinger (Preço saiu do canal)",
  ema_cross:      "9. Cruzamento de Tendência (Média Exponencial)",
  sma_cross:      "10. Cruzamento de Tendência (Média Simples)",
  macd:           "11. Momentum do Preço (MACD)",
  candle_color:   "12. Cor fixa em posição específica",
  ma_compare:     "13. Média Móvel Personalizada (Trend Follow)",
};

export const RULE_TYPE_HINT: Record<RuleType, string> = {
  candle_body:    "Verifica se a última vela fechou Verde (Call) ou Vermelha (Put). Simples e direto.",
  consecutive:    "Gera sinal após várias velas da mesma cor. Ex: 3 velas verdes seguidas podem indicar força de alta.",
  wick_size:      "Ideal para identificar rejeição. Ex: Pavio superior muito longo indica que o preço tentou subir e foi empurrado para baixo.",
  breakout:       "Detecta quando o preço quebra uma barreira de máxima ou mínima dos últimos candles.",
  candle_compare: "Compara qualquer preço (abertura, fechamento, máxima ou mínima) com velas anteriores.",
  engulfment:     "Verifica se a vela atual fechou acima (Call) ou abaixo (Put) de todo o corpo e pavio da vela anterior.",
  rsi:            "Mostra se o preço está esticado demais para cima (comprar put) ou para baixo (comprar call).",
  bollinger:      "As bandas indicam limites de volatilidade. Preço fora da banda costuma retornar ao centro.",
  ema_cross:      "Médias rápidas cruzando lentas indicam mudança na tendência principal.",
  sma_cross:      "Similar às EMAs, mas com resposta um pouco mais lenta e estável.",
  macd:           "Usa o histograma para ver se o movimento está ganhando ou perdendo força.",
  candle_color:   "Permite definir a cor de um candle específico atrás (Ex: 'o antepenúltimo foi vermelho').",
  ma_compare:     "Flexível: compare uma média móvel (EMA/SMA) com o preço atual ou com outra média para seguir a tendência.",
};
