import datetime
import time
from safirionapi.ws.chanels.base import Base
import logging
import safirionapi.global_value as global_value
from safirionapi.expiration import get_expiration_time
...
class Buyv3(Base):
    ...
    def __call__(self, price, active, direction, duration, request_id):
        ...
        now_date = datetime.datetime.fromtimestamp(self.api.timesync.server_timestamp)
