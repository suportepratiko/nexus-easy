...
from safirionapi.http.login import Login
from safirionapi.http.loginv2 import Loginv2
from safirionapi.http.logout import Logout
from safirionapi.http.login2fa import Login2FA
from safirionapi.http.send_sms import SMS_Sender
from safirionapi.http.verify import Verify
from safirionapi.http.getprofile import Getprofile
from safirionapi.http.auth import Auth
from safirionapi.http.token import Token
from safirionapi.http.appinit import Appinit
from safirionapi.http.billing import Billing
from safirionapi.http.buyback import Buyback
from safirionapi.http.changebalance import Changebalance
from safirionapi.http.events import Events
from safirionapi.ws.client import WebsocketClient
from safirionapi.ws.chanels.get_balances import *

from safirionapi.ws.chanels.ssid import Ssid
from safirionapi.ws.chanels.subscribe import *
from safirionapi.ws.chanels.unsubscribe import *
from safirionapi.ws.chanels.setactives import SetActives
from safirionapi.ws.chanels.candles import GetCandles
from safirionapi.ws.chanels.buyv2 import Buyv2
from safirionapi.ws.chanels.buyv3 import *
from safirionapi.ws.chanels.user import *
from safirionapi.ws.chanels.api_game_betinfo import Game_betinfo
from safirionapi.ws.chanels.instruments import Get_instruments
from safirionapi.ws.chanels.get_financial_information import GetFinancialInformation
from safirionapi.ws.chanels.strike_list import Strike_list
from safirionapi.ws.chanels.leaderboard import Leader_Board

from safirionapi.ws.chanels.traders_mood import Traders_mood_subscribe
from safirionapi.ws.chanels.traders_mood import Traders_mood_unsubscribe
from safirionapi.ws.chanels.technical_indicators import Technical_indicators
from safirionapi.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from safirionapi.ws.chanels.get_order import Get_order
from safirionapi.ws.chanels.get_deferred_orders import GetDeferredOrders
from safirionapi.ws.chanels.get_positions import *

from safirionapi.ws.chanels.get_available_leverages import Get_available_leverages
from safirionapi.ws.chanels.cancel_order import Cancel_order
from safirionapi.ws.chanels.close_position import Close_position
from safirionapi.ws.chanels.get_overnight_fee import Get_overnight_fee
from safirionapi.ws.chanels.heartbeat import Heartbeat


from safirionapi.ws.chanels.digital_option import *
from safirionapi.ws.chanels.api_game_getoptions import *
from safirionapi.ws.chanels.sell_option import Sell_Option
from safirionapi.ws.chanels.sell_digital_option import Sell_Digital_Option
from safirionapi.ws.chanels.change_tpsl import Change_Tpsl
from safirionapi.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall
from safirionapi.ws.chanels.buy_blitz_option import BuyBlitzOption

from safirionapi.ws.objects.timesync import TimeSync
from safirionapi.ws.objects.profile import Profile
from safirionapi.ws.objects.candles import Candles
from safirionapi.ws.objects.listinfodata import ListInfoData
from safirionapi.ws.objects.betinfo import Game_betinfo_data
...
class Safirionapi(object):  # pylint: disable=too-many-instance-attributes
    """Class for communication with Avalon Broker API."""
    ...
    def __init__(self, host, username, password, proxies=None):
        """
        :param str host: The hostname or ip address of an Avalon server.
        :param str username: The username of an Avalon server.
        :param str password: The password of an Avalon server.
        :param dict proxies: (optional) The http request proxies.
        """
        # Extrair o domínio base (sem ws. se tiver)
        base_host = host.replace('ws.', '')
        api_host = os.environ.get("SAFIRION_API_HOST") or host.replace('ws.', 'api.')

        # URLs da API
        self.url_login = f"https://{api_host}/v2/login"
        self.url_logout = f"https://{api_host}/v1.0/logout"
        self.url_auth2 = f"https://{api_host}/v2/verify/2fa"
        self.url_events = f"https://{api_host}/v1/events"
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <avalonapi.http.resource.Resource>`.
    ...
    def login_2fa(self):
        ...
        :returns: The instance of :class:`Login2FA
            <avalonapi.http.login2fa.Login2FA>`.
        """
    ...
    def send_sms_code(self):
        ...
        :returns: The instance of :class:`SMS_Sender
            <avalonapi.http.send_sms.SMS_Sender>`.
        """
    ...
    def loginv2(self):
        ...
        :returns: The instance of :class:`Loginv2
            <avalonapi.http.loginv2.Loginv2>`.
        """
        return Loginv2(self)
    ...
    def appinit(self):
        ...
        :returns: The instance of :class:`Appinit
            <avalonapi.http.appinit.Appinit>`.
        """
        return Appinit(self)
    ...
    #         <avalonapi.http.profile.Profile>`.
    #     """
    #     return Profile(self)
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <avalonapi.http.changebalance.Changebalance>`.
        """
    ...
    def billing(self):
        ...
        :returns: The instance of :class:`Billing
            <avalonapi.http.billing.Billing>`.
        """
        return Billing(self)
    ...
    def buyback(self):
        ...
        :returns: The instance of :class:`Buyback
            <avalonapi.http.buyback.Buyback>`.
        """
        return Buyback(self)
# ------------------------------------------------------------------------
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <avalonapi.http.getprofile.Getprofile>`.
        """
...
# ----------------------------------------------------------------------------
    ...
    def ssid(self):
        ...
        :returns: The instance of :class:`Ssid
            <avalonapi.ws.chanels.ssid.Ssid>`.
        """
        return Ssid(self)
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <avalonapi.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <avalonapi.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <avalonapi.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <avalonapi.ws.chanels.candles.GetCandles>`.
        """
...
# ____________for_______binary_______option_____________
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <avalonapi.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
    ...
    def buy_blitz_option(self):
        ...
        :returns: The instance of :class:`BuyBlitzOption
            <avalonapi.ws.chanels.buy_blitz_option.BuyBlitzOption>`.
        """
...
# -------------------------------------------------------
    ...
    def start_websocket(self):
        ...
        while time.time() - start_t < 30:
            try:
                ...
                pass
            time.sleep(0.1)
        return False, "WebSocket connection timeout (30s)."
    ...
    def send_ssid(self):
        ...
        start_t = time.time()
        while self.profile.msg == None and time.time() - start_t < 30:
            time.sleep(0.1)
        if self.profile.msg == False or self.profile.msg == None:
            return False
        else:
            return True
    ...
    def connect(self):
        ...
        if self.timesync.server_timestamp is None:
            return False, "Timestamp sync timeout (30s)."
        return True, None
